  ...
  return (
    ...
    <div className="flex flex-1">
      ...
      <motion.div
        ...
        className="flex flex-col items-center justify-center cursor-pointer px-8 md:px-16 select-none"
      >
        <motion.div
      ...
      {/* Divider */}
      <div className="w-px bg-[#E5E5E5] flex-shrink-0 self-stretch my-12" />
    ...
    >
      <button
        ...
        className="text-sm text-gray-400 hover:text-gray-600 hover:underline underline-offset-4 transition-colors"
      >
