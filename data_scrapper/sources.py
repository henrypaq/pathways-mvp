...
IRCC_SOURCES = [
    ...
    {
        "url": "https://www.canada.ca/en/immigration-refugees-citizenship/services/immigrate-canada/rural-community-immigration-class.html",
        "display_name": "Rural Community Immigration Class",
        "section": "Permanent Residence",
        "visa_types": ["pr"],
        "programs": ["RCIC"],
        "high_change": False,
